...
namespace Sistema_Sapataria.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            // 1. Pega o caminho para a pasta de dados local da aplicação (que é gravável)
            string dbFolderPath = ApplicationData.Current.LocalFolder.Path;

            // 2. Define o nome do seu arquivo de banco de dados
            string dbFileName = "vendas.db";

            // 3. Combina os dois para ter o caminho completo e correto
            string databasePath = Path.Combine(dbFolderPath, dbFileName);

            // 4. Informa ao Entity Framework para usar este caminho
            // Ele criará o arquivo "vendas.db" nesta pasta se não existir.
            optionsBuilder.UseSqlite($"Data Source={databasePath}");
        }
