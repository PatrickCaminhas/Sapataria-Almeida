...
namespace Sapataria_Almeida.ViewModels
{
    public partial class GraficosMensaisViewModel : ObservableObject
    {
        ...
        private async Task LoadArrecadacaoMensalAsync()
        {
            ...
            var labels = diasDoMes.Select(d => d.Day.ToString("00")).ToArray();
            ...
            MonthlySeries = new ObservableCollection<ISeries>
        {
            ...
            MonthlyXAxes = new[] { new Axis { Name = "Dia do Mês", Labels = labels } };
            MonthlyYAxes = new[] { new Axis { Name = "Valor (R$)", Labeler = v => v.ToString("C0", CultureInfo.GetCultureInfo("pt-BR")), MinLimit = 0 } };
        }
